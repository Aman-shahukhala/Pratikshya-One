        ...
        <Reveal variant="scale">
          <div className="relative rounded-2xl overflow-hidden mb-10 border border-slate-200 shadow-md bg-slate-900">
            <img
              ...
              className="w-full h-[300px] sm:h-[400px] object-cover opacity-60"
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {platform.map((item, i) => (
            <Reveal key={item.title} delay={i * 100}>
              <div className="bg-white border border-slate-200/80 rounded-2xl p-8 h-full shadow-sm hover:shadow-md hover:border-slate-300 transition-all duration-300 hover:-translate-y-1">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <span className="text-[11px] px-2.5 py-1 rounded-full font-semibold bg-blue-50 text-blue-700">
                    {item.shared}
                  </span>
                </div>
          ...
          <Reveal delay={500}>
            <div className="rounded-2xl p-8 h-full bg-slate-50 border border-slate-200/80 shadow-sm hover:shadow-md hover:border-slate-300 transition-all duration-300 hover:-translate-y-1">
              <h3 className="text-base font-semibold text-slate-900 mb-3">Adaptive Calibration</h3>
